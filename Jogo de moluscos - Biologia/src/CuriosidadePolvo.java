...
public class CuriosidadePolvo extends JFrame implements MouseListener, Runnable{
	
	JLabel titulo = new JLabel();
	JLabel caixa = new JLabel();
	JLabel barraS = new JLabel();
	JLabel barraI = new JLabel();
	JLabel bg = new JLabel(new ImageIcon(getClass().getResource("imagens/polvinho/bg.png")));
	JLabel curiosidades = new JLabel(new ImageIcon(getClass().getResource("imagens/polvinho/curiosidades.png")));
	...
	public void componentes(){
		...
		titulo.setBackground(new Color(0, 145, 206));
		...
		caixa.setBackground(new Color(0, 145, 206));
		add(caixa);
	...
	public void mouseClicked(MouseEvent clicou) {
		...
		if(clicou.getSource().equals(sair)){
			dispose();
			Tela tela = new Tela();
			tela.playCaracol.setVisible(false);
			tela.playPolvo.setVisible(true);
		}
	}
