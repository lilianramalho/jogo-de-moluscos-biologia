...
public class CuriosidadeOstra extends JFrame implements MouseListener, Runnable{
	
	JLabel titulo = new JLabel();
	JLabel caixa = new JLabel();
	JLabel barraS = new JLabel();
	JLabel barraI = new JLabel();
	JLabel bg = new JLabel(new ImageIcon(getClass().getResource("imagens/ostrinha/fundo.png")));
	JLabel curiosidades = new JLabel(new ImageIcon(getClass().getResource("imagens/ostrinha/curiosidades.png")));
	Color corDaCaixa = new Color(11, 102, 147);
	...
	public void componentes(){
		...
		titulo.setBackground(new Color(11, 102, 147));
