...
public class CuriosidadeCaracol extends JFrame implements MouseListener, Runnable{
	
	JLabel titulo = new JLabel();
	JLabel caixa = new JLabel();
	JLabel barraS = new JLabel();
	JLabel barraI = new JLabel();
	JLabel bg = new JLabel(new ImageIcon(getClass().getResource("imagens/caracolzinho/bgInicial.png")));
	JLabel curiosidades = new JLabel(new ImageIcon(getClass().getResource("imagens/caracolzinho/curiosidades.png")));
	JLabel prox = new JLabel();
	JLabel sair = new JLabel();
	Color corDaCaixa = new Color(234, 0, 0);
	
	int ir, c;
	
	
	public CuriosidadeCaracol(){
	...
	public void componentes(){
		...
		titulo.setBackground(new Color(234, 0, 0));
