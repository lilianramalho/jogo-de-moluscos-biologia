...
public class instrOstra extends JFrame implements MouseListener{
	JLabel[] vetor = new JLabel[3];
	
	JLabel label1 = new JLabel(new ImageIcon(getClass().getResource("img/ostra1.png")));
	...
	JLabel label2 = new JLabel(new ImageIcon(getClass().getResource("img/ostra2.png")));
